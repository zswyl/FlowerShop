		...
		<div class="row">
			...
			<div class="col-sm-3 col-md-2 sidebar sidebar-1">
				<ul class="nav nav-sidebar">
					<li class="list-group-item-diy"><a href="#productArea1">爱情鲜花 <span class="sr-only">(current)</span></a></li>
					<li class="list-group-item-diy"><a href="#productArea2">生日鲜花</a></li>
					<li class="list-group-item-diy"><a href="#productArea3">探病慰问</a></li>
					<li class="list-group-item-diy"><a href="#productArea4">商务鲜花</a></li>
					<li class="list-group-item-diy"><a href="#productArea5">祝福庆贺</a></li>
					<li class="list-group-item-diy"><a href="#productArea6">婚庆鲜花</a></li>
					<li class="list-group-item-diy"><a href="#productArea7">道歉鲜花</a></li>
					<li class="list-group-item-diy"><a href="#productArea8">哀思鲜花</a></li>
				</ul>
			</div>
			<!-- 控制内容 -->
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="jumbotron">
					<h1>欢迎来到佩奇花店</h1>
					<p>佩奇花店是一家物美价廉的鲜花店，它几乎涵盖市场上所有的鲜花哦</p>
				</div>
