...
public class UserController {
    ...
    public String updateProduct(int userId, Model model) {
    ...
    @ResponseBody
    public Map<String, Object> doUpdate(String userName, String email, String nickName, String phoneNumber, String postNumber, String address) {
        String result = "fail";
        User user = userService.getUser(userName);
        user.setNickName(nickName);
        userService.updateUser(user);
