...
public class ProductController {
    ...
    public String updateProduct(int productId, Model model) {
        Product product = productService.getProduct(productId);
         model.addAttribute("upProduct",product);
        return "updateProduct";
    }

    @RequestMapping(value = "/doUpdateProduct")
    public String doUpdateProduct(String productName,String productDescribe,String keyWord,int productPrice,int productCount,int productType) {
        System.out.println("更新了商品："+productName);
        Product product = productService.getProduct(productName);
        product.setName(productName);
        product.setDescription(productDescribe);
        product.setKeyWord(keyWord);
        product.setPrice(productPrice);
        product.setCounts(productCount);
